...
real(dp) :: m1, m2, mtotal, mc, eta, tsolar=4.925491_dp*10.0_dp**(-6), &
       ...
       Beta_PPE,H0,SNR,sigma_vel,n_gal,Omega_s_68,dc_min,dc_max,Vc_min,Vc_max,n_host,dl_rescale,k_p,&
       b_PPE,gasdev,m10,m20,idum1,idum2,idum
...
!************************************************
   ...
   m1=36.2_dp*(1.0_dp+z)
    ...
    tc=1126259462.4158_dp  !Average gpstime
    !GMST=0._dp
    phic=0.0_dp
...
open (unit=1,file='sky-average.txt')
...
write (1,*) sigma90*sqrt(fmi(11,11))
