...
real(dp) :: m1, m2, mtotal, mc, eta, tsolar=4.925491_dp*10.0_dp**(-6), &
       ...
       b_PPE,Beta_PPE,gasdev,m10,m20,idum1,idum2,idum,ran1
...
real(dp), dimension(1000):: a1,	a2,	distance,	theta_jn,	time,	time_gmst, mass1_det,	right_ascension,	mass2_det,	declination
...
open (unit=11,file='monte-carlo.txt')!Output file
open(unit=10,file='overall_post.csv') ! Input file containing LIGO data

do k=1,1000 !Do loop for reading LIGO data. Change it to 46848 if you want to read all the data
 
read (10,*) a1(k),	a2(k),	distance(k),	theta_jn(k),	time(k),   mass1_det(k),	right_ascension(k),mass2_det(k),	declination(k)
  ...
  psi=pi_d*ran1(idum) !randomly distributed between o to pi

   m1=mass1_det(k)*tsolar !mass1_det(k) is in solar mass unit

   m2=mass2_det(k)*tsolar

    phic=2._dp*pi_d*ran1(idum) !randomly distributed between o to 2*pi
...
call wave(f,mc,eta,chi,const,tc,phic,alpha,delta,psi,inc,Beta_PPE,ad1,ad2,ad3,f3)
...
call fish(mtotal,eta,chi,const,tc,phic,alpha,delta,psi,inc,Beta_PPE,fm,fmi)

!write (11,'(2E22.14)')  sigma90*sqrt(fmi(11,11))
write (11,*)chi
...
subroutine fish(mtotal,eta,chi,const,tc,phic,alpha,delta,psi,inc,Beta_PPE,fm,fmi)

use nrtype_qp
implicit none

!input parameters
real(dp), intent(in) :: mtotal,eta,chi,const,tc,phic,alpha,delta,psi,inc,Beta_PPE
...
call wave(f,mc*(1._dp+epsilon),eta,chi,const,tc,phic,alpha,delta,psi,inc,Beta_PPE,adt1,adt2,adt3,f3)
!This second one is for complex conjugate
call wave(f,mc*(1._dp-epsilon),eta,chi,const,tc,phic,alpha,delta,psi,inc,Beta_PPE,adt_1,adt_2,adt_3,f3)
!Hangford LIGO
...
call wave(f,mc,eta*(1._dp+epsilon),chi,const,tc,phic,alpha,delta,psi,inc,Beta_PPE,adt1,adt2,adt3,f3)
call wave(f,mc,eta*(1._dp-epsilon),chi,const,tc,phic,alpha,delta,psi,inc,Beta_PPE,adt_1,adt_2,adt_3,f3)
dad1(2)=(adt1-adt_1)/(2.0_dp*epsilon)
dad2(2)=(adt2-adt_2)/(2.0_dp*epsilon)
dad3(2)=(adt3-adt_3)/(2.0_dp*epsilon)

call wave(f,mc,eta,chi+epsilon,const,tc,phic,alpha,delta,psi,inc,Beta_PPE,adt1,adt2,adt3,f3)
call wave(f,mc,eta,chi-epsilon,const,tc,phic,alpha,delta,psi,inc,Beta_PPE,adt_1,adt_2,adt_3,f3)
dad1(3)=(adt1-adt_1)/(2.0_dp*epsilon)
dad2(3)=(adt2-adt_2)/(2.0_dp*epsilon)
dad3(3)=(adt3-adt_3)/(2.0_dp*epsilon)

call wave(f,mc,eta,chi,const*(1._dp+epsilon),tc,phic,alpha,delta,psi,inc,Beta_PPE,adt1,adt2,adt3,f3)
call wave(f,mc,eta,chi,const*(1._dp-epsilon),tc,phic,alpha,delta,psi,inc,Beta_PPE,adt_1,adt_2,adt_3,f3)
dad1(4)=(adt1-adt_1)/(2.0_dp*epsilon)
dad2(4)=(adt2-adt_2)/(2.0_dp*epsilon)
dad3(4)=(adt3-adt_3)/(2.0_dp*epsilon)

call wave(f,mc,eta,chi,const,tc*(1._dp+epsilon),phic,alpha,delta,psi,inc,Beta_PPE,adt1,adt2,adt3,f3)
call wave(f,mc,eta,chi,const,tc*(1._dp-epsilon),phic,alpha,delta,psi,inc,Beta_PPE,adt_1,adt_2,adt_3,f3)
dad1(5)=(adt1-adt_1)/(2.0_dp*epsilon)
dad2(5)=(adt2-adt_2)/(2.0_dp*epsilon)
dad3(5)=(adt3-adt_3)/(2.0_dp*epsilon)

call wave(f,mc,eta,chi,const,tc,phic+epsilon,alpha,delta,psi,inc,Beta_PPE,adt1,adt2,adt3,f3)
call wave(f,mc,eta,chi,const,tc,phic-epsilon,alpha,delta,psi,inc,Beta_PPE,adt_1,adt_2,adt_3,f3)
dad1(6)=(adt1-adt_1)/(2.0_dp*epsilon)
dad2(6)=(adt2-adt_2)/(2.0_dp*epsilon)
dad3(6)=(adt3-adt_3)/(2.0_dp*epsilon)

call wave(f,mc,eta,chi,const,tc,phic,alpha+epsilon,delta,psi,inc,Beta_PPE,adt1,adt2,adt3,f3)
call wave(f,mc,eta,chi,const,tc,phic,alpha-epsilon,delta,psi,inc,Beta_PPE,adt_1,adt_2,adt_3,f3)
dad1(7)=(adt1-adt_1)/(2.0_dp*epsilon)
dad2(7)=(adt2-adt_2)/(2.0_dp*epsilon)
dad3(7)=(adt3-adt_3)/(2.0_dp*epsilon)

call wave(f,mc,eta,chi,const,tc,phic,alpha,delta+epsilon,psi,inc,Beta_PPE,adt1,adt2,adt3,f3)
call wave(f,mc,eta,chi,const,tc,phic,alpha,delta-epsilon,psi,inc,Beta_PPE,adt_1,adt_2,adt_3,f3)
dad1(8)=(adt1-adt_1)/(2.0_dp*epsilon)
dad2(8)=(adt2-adt_2)/(2.0_dp*epsilon)
dad3(8)=(adt3-adt_3)/(2.0_dp*epsilon)

call wave(f,mc,eta,chi,const,tc,phic,alpha,delta,psi+epsilon,inc,Beta_PPE,adt1,adt2,adt3,f3)
call wave(f,mc,eta,chi,const,tc,phic,alpha,delta,psi-epsilon,inc,Beta_PPE,adt_1,adt_2,adt_3,f3)
dad1(9)=(adt1-adt_1)/(2.0_dp*epsilon)
dad2(9)=(adt2-adt_2)/(2.0_dp*epsilon)
dad3(9)=(adt3-adt_3)/(2.0_dp*epsilon)

call wave(f,mc,eta,chi,const,tc,phic,alpha,delta,psi,inc+epsilon,Beta_PPE,adt1,adt2,adt3,f3)
call wave(f,mc,eta,chi,const,tc,phic,alpha,delta,psi,inc-epsilon,Beta_PPE,adt_1,adt_2,adt_3,f3)
dad1(10)=(adt1-adt_1)/(2.0_dp*epsilon)
dad2(10)=(adt2-adt_2)/(2.0_dp*epsilon)
dad3(10)=(adt3-adt_3)/(2.0_dp*epsilon)

call wave(f,mc,eta,chi,const,tc,phic,alpha,delta,psi,inc,Beta_PPE+epsilon,adt1,adt2,adt3,f3)
call wave(f,mc,eta,chi,const,tc,phic,alpha,delta,psi,inc,Beta_PPE-epsilon,adt_1,adt_2,adt_3,f3)
...
subroutine wave(f,mc,eta,chi,const,tc,phic,alpha,delta,psi,inc,Beta_PPE,ad1,ad2,ad3,f3)

use nrtype_qp
implicit none

!input binary & theory parameters
real(dp), intent(in) :: f,mc,eta,chi,const,tc,phic,alpha,delta,psi,inc,Beta_PPE
